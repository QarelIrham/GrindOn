...
content = """
    ...
    AvatarItem(id: 'head_bald_buddy', name: 'Bald Buddy', icon: Icons.face, imagePath: 'lib/assets/Head/head_bald_buddy.png', color: AppColors.textPrimary, category: 'Head', price: 200, tier: AvatarTier.novice),
    ...
    AvatarItem(id: 'head_casual_ponytail', name: 'Casual Ponytail', icon: Icons.face, imagePath: 'lib/assets/Head/head_casual_ponytail.png', color: AppColors.textPrimary, category: 'Head', price: 350, tier: AvatarTier.novice),
    ...
    AvatarItem(id: 'head_brown_bob_heart', name: 'Brown Bob', icon: Icons.face, imagePath: 'lib/assets/Head/head_brown_bob_heart.png', color: AppColors.textPrimary, category: 'Head', price: 500, tier: AvatarTier.novice),
    ...
    AvatarItem(id: 'body_set_blue_floral_dress', name: 'Floral Dress', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_set_blue_floral_dress.png', color: AppColors.textPrimary, category: 'Body 1 Set', price: 800, tier: AvatarTier.novice),
    ...
    AvatarItem(id: 'head_red_bob', name: 'Red Bob', icon: Icons.face, imagePath: 'lib/assets/Head/head_red_bob.png', color: Colors.blue, category: 'Head', price: 1400, tier: AvatarTier.veteran),
    ...
    AvatarItem(id: 'head_pink_bow_bob', name: 'Pink Bow Bob', icon: Icons.face, imagePath: 'lib/assets/Head/head_pink_bow_bob.png', color: Colors.blue, category: 'Head', price: 2000, tier: AvatarTier.veteran),
    ...
    AvatarItem(id: 'head_pink_twintails', name: 'Pink Twintails', icon: Icons.face, imagePath: 'lib/assets/Head/head_pink_twintails.png', color: Colors.blue, category: 'Head', price: 3200, tier: AvatarTier.veteran),
    ...
    AvatarItem(id: 'body_orc', name: 'Orc Body', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_orc.png', color: Colors.blue, category: 'Body 1 Set', price: 3500, tier: AvatarTier.veteran),
    AvatarItem(id: 'body_set_magical_pink_dress', name: 'Pink Dress', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_set_magical_pink_dress.png', color: Colors.blue, category: 'Body 1 Set', price: 3800, tier: AvatarTier.veteran),
    ...
    AvatarItem(id: 'head_ice_bob', name: 'Ice Bob', icon: Icons.face, imagePath: 'lib/assets/Head/head_ice_bob.png', color: Colors.purple, category: 'Head', price: 6500, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'head_mint_lotus', name: 'Mint Lotus', icon: Icons.face, imagePath: 'lib/assets/Head/head_mint_lotus.png', color: Colors.purple, category: 'Head', price: 9000, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'head_nerd_scholar', name: 'Nerd Scholar', icon: Icons.face, imagePath: 'lib/assets/Head/head_nerd_scholar.png', color: Colors.purple, category: 'Head', price: 11000, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'head_neon_cyber', name: 'Neon Cyber', icon: Icons.face, imagePath: 'lib/assets/Head/head_neon_cyber.png', color: Colors.purple, category: 'Head', price: 15000, tier: AvatarTier.elite),
    AvatarItem(id: 'head_shaolin_monk', name: 'Shaolin Monk', icon: Icons.face, imagePath: 'lib/assets/Head/head_shaolin_monk.png', color: Colors.purple, category: 'Head', price: 18000, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'armor_wizard_robe', name: 'Wizard Robe', icon: Icons.auto_awesome, imagePath: 'lib/assets/Body1Set/armor_wizard_robe.png', color: Colors.purple, category: 'Body 1 Set', price: 11000, tier: AvatarTier.elite),
    AvatarItem(id: 'body_set_mechagirl_armor', name: 'Mecha Girl', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_set_mechagirl_armor.png', color: Colors.purple, category: 'Body 1 Set', price: 12000, tier: AvatarTier.elite),
    AvatarItem(id: 'body_engineer', name: 'Engineer Body', icon: Icons.build, imagePath: 'lib/assets/Body1Set/body_engineer.png', color: Colors.purple, category: 'Body 1 Set', price: 13000, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'body_set_fairy_leaf_wings', name: 'Fairy Leaf', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_set_fairy_leaf_wings.png', color: Colors.purple, category: 'Body 1 Set', price: 18000, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'body_set_fire_girl', name: 'Fire Girl Set', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_set_fire_girl.png', color: Colors.amber, category: 'Body 1 Set', price: 35000, tier: AvatarTier.mythic),
    ...
    AvatarItem(id: 'body_set_frost_empress_gown', name: 'Frost Empress', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_set_frost_empress_gown.png', color: Colors.amber, category: 'Body 1 Set', price: 48000, tier: AvatarTier.mythic),
    ...
    AvatarItem(id: 'body_set_gorgon_golden_armor', name: 'Gorgon Armor', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_set_gorgon_golden_armor.png', color: Colors.amber, category: 'Body 1 Set', price: 65000, tier: AvatarTier.mythic),
    ...
    AvatarItem(id: 'head_amazon_princess', name: 'Amazon Princess', icon: Icons.face, imagePath: 'lib/assets/Head/head_amazon_princess.png', color: Colors.amber, category: 'Head', price: 28000, tier: AvatarTier.mythic),
    ...
    AvatarItem(id: 'head_princess', name: 'Princess Crown', icon: Icons.face, imagePath: 'lib/assets/Head/head_princess.png', color: Colors.amber, category: 'Head', price: 32000, tier: AvatarTier.mythic),
    ...
    AvatarItem(id: 'head_fire_girl', name: 'Fire Girl', icon: Icons.face, imagePath: 'lib/assets/Head/head_fire_girl.png', color: Colors.amber, category: 'Head', price: 42000, tier: AvatarTier.mythic),
    ...
    AvatarItem(id: 'head_medusa_snakes', name: 'Medusa Snakes', icon: Icons.face, imagePath: 'lib/assets/Head/head_medusa_snakes.png', color: Colors.amber, category: 'Head', price: 50000, tier: AvatarTier.mythic),
    ...
    AvatarItem(id: 'head_veteran_mercenary', name: 'Mercenary', icon: Icons.face, imagePath: 'lib/assets/Head/head_veteran_mercenary.png', color: Colors.amber, category: 'Head', price: 60000, tier: AvatarTier.mythic),
...
with open('lib/models/avatar_data.dart', 'r') as f:
    orig = f.read()
    
# regex to replace static final List<AvatarItem> allItems = [ ... ];
# because it's a huge block, we just do a string replacement using split
parts = orig.split('static final List<AvatarItem> allItems = [')
parts2 = parts[1].split('];\n\n  static Map<String, double> getEquippedStats')

new_file = parts[0] + 'static final List<AvatarItem> allItems = [' + content + '];\n\n  static Map<String, double> getEquippedStats' + parts2[1]

with open('lib/models/avatar_data.dart', 'w') as f:
    f.write(new_file)
