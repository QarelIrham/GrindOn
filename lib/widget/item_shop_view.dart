      ...
      children: [
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              _buildItemRow(id: 'red_potion', name: 'Red Potion', desc: 'Pulihkan 30 HP secara instan.', price: 50, icon: Icons.local_hospital_rounded, color: Colors.redAccent),
              const SizedBox(height: 12),
              _buildItemRow(id: 'blue_potion', name: 'Blue Potion', desc: 'Pulihkan 60 HP secara instan.', price: 100, icon: Icons.water_drop, color: Colors.blue),
              const SizedBox(height: 12),
              _buildItemRow(id: 'green_potion', name: 'Green Potion', desc: 'Pulihkan 100 HP secara instan.', price: 150, icon: Icons.health_and_safety, color: Colors.green),
              const SizedBox(height: 12),
              _buildItemRow(id: 'xp_scroll', name: 'XP Scroll', desc: 'Double XP selama 1 jam.', price: 100, icon: Icons.history_edu_rounded, color: Colors.amber),
              const SizedBox(height: 12),
              _buildItemRow(id: 'gold_scroll', name: 'Gold Scroll', desc: 'Double Gold selama 1 jam.', price: 100, icon: Icons.request_quote_rounded, color: Colors.yellow),
              const SizedBox(height: 12),
              _buildItemRow(id: 'strength_potion', name: 'Strength Potion', desc: 'Tambah 50 Strength XP.', price: 120, icon: Icons.fitness_center, color: Colors.deepOrange),
              const SizedBox(height: 12),
              _buildItemRow(id: 'agility_potion', name: 'Agility Potion', desc: 'Tambah 50 Agility XP.', price: 120, icon: Icons.directions_run, color: Colors.teal),
              const SizedBox(height: 12),
              _buildItemRow(id: 'intelligence_potion', name: 'Intelligence Potion', desc: 'Tambah 50 Intelligence XP.', price: 120, icon: Icons.lightbulb, color: Colors.purple),
              const SizedBox(height: 12),
              _buildItemRow(id: 'vitality_potion', name: 'Vitality Potion', desc: 'Tambah 50 Vitality XP.', price: 120, icon: Icons.favorite, color: Colors.pink),
              const SizedBox(height: 12),
              _buildItemRow(id: 'defense_potion', name: 'Defense Potion', desc: 'Tambah 50 Defense XP.', price: 120, icon: Icons.shield, color: Colors.blueGrey),
              const SizedBox(height: 12),
              _buildItemRow(id: 'mystery_box', name: 'Mystery Box', desc: 'Buka untuk hadiah acak misterius!', price: 200, icon: Icons.card_giftcard_rounded, color: Colors.deepPurpleAccent),
              const SizedBox(height: 12),
              _buildItemRow(id: 'revive_token', name: 'Revive Token', desc: 'Sembuhkan Burnout & isi penuh HP.', price: 500, icon: Icons.healing_rounded, color: Colors.cyan),
            ],
          ),
        ),
      ],
            ...
            children: [
              ...
              if (count > 0)
                ElevatedButton(
                  ...
                  onPressed: () => onUse(id),
                  child: const Text('GUNAKAN', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 10)),
                ),
            ],
          ),
        ],
