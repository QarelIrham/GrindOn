...
class AvatarData {
  static final List<AvatarItem> allItems = [
    ...
    AvatarItem(id: 'head_ice_bob', name: 'Ratu Es', icon: Icons.face, imagePath: 'lib/assets/Head/head_ice_bob.png', color: Colors.amber, category: 'Head', price: 35000, tier: AvatarTier.mythic),
    ...
    AvatarItem(id: 'body_set_fire_girl', name: 'Fire Girl Set', icon: Icons.checkroom, imagePath: 'lib/assets/Body1Set/body_set_fire_girl.png', color: Colors.purple, category: 'Body 1 Set', price: 16000, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'head_princess', name: 'Princess Crown', icon: Icons.face, imagePath: 'lib/assets/Head/head_princess.png', color: Colors.purple, category: 'Head', price: 17000, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'head_fire_girl', name: 'Fire Girl', icon: Icons.face, imagePath: 'lib/assets/Head/head_fire_girl.png', color: Colors.purple, category: 'Head', price: 16000, tier: AvatarTier.elite),
    ...
    AvatarItem(id: 'head_veteran_mercenary', name: 'Mercenary', icon: Icons.face, imagePath: 'lib/assets/Head/head_veteran_mercenary.png', color: Colors.purple, category: 'Head', price: 15000, tier: AvatarTier.elite),
